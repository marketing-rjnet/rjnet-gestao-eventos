...
| 6 | `supabase/migracao-soft-delete-audit.sql` | ⚠️ Pendente execução em produção (PA-07) | Colunas `deletado_em` e `deletado_por` em `leads` — rastreabilidade de soft delete |
