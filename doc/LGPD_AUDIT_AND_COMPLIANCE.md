...
| L-08 | Exportação CSV sem controle ou rastreabilidade — risco de vazamento | Art. 6º, VII (segurança) | **ALTA** |
...
| ID | Não Conformidade | Classificação |
|----|-----------------|--------------|
| A-01 | Sem log de exportações CSV | **ALTA** |
...
**Status:** 🟡 Em progresso (2/3 concluído)
