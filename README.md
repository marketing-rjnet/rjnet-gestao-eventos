...
Estas regras **não devem ser alteradas sem registrar uma decisão** em `docs/DECISIONS.md`:
...
Detalhes completos em `docs/REFATORAÇÃO.md`.
...
| Arquivo | Conteúdo |
|---------|----------|
| `docs/SYSTEM_MAP.md` | Arquitetura viva — estrutura, fluxo de dados e restrições |
| `docs/DECISIONS.md` | Histórico de decisões arquiteturais com justificativas |
| `docs/SUPABASE.md` | Configuração detalhada do Supabase (schema, RLS, usuários de teste) |
| `docs/CHANGELOG.md` | Histórico completo de mudanças por versão |
